...
if __name__ == '__main__':
    ...
    nhits_config = {
        ...
        "batch_size": tune.choice([32]),                                           # Number of series in windows
        ...
        "n_blocks":  tune.choice([[1, 1, 1],[3,3,3]]),                                    # Blocks per each 3 stacks
        "mlp_units":  tune.choice([[[512, 512], [512, 512], [512, 512]],[[256,256]]*3,[[64,64]]*3]),        # 2 512-Layers per block for each stack
    ...
    yhat_file = f'./data/{dataset}/{horizon}_nhits_forecasts.csv'
