...
class model_backbone(nn.Module):
    ...
    def forward(self, windows_batch):
        ...
        ### decomp:
        z, z_mean, z_var = self.decompsition(z.permute(0, 2, 1))
        z, z_mean, z_var = z.permute(0, 2, 1), z_mean.permute(0, 2, 1), z_var.permute(0, 2, 1)    
        # [Batch, 1, input_size]
        ...
        # fine-tune阶段 
            ...
            z = self.output_layer(torch.cat((z, z_var, z_mean), dim=1))
            z = z.unsqueeze(1)
